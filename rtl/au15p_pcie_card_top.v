// ============================================================================
// Module: au15p_pcie_card_top
// Target: AMD/Xilinx Artix UltraScale+ (xcau15p-ffvb676-2-e)
// Description: Cost-Down Top-level FPGA card wrapper module.
//              Uses pcie4c_uscale_plus_0 (Compact PCIe4 Block) for AU15P.
//              100% shared core DMA logic with Kintex KU3P solution.
// ============================================================================
...
module au15p_pcie_card_top #(
    ...
    // Address conversion wires for AXI Crossbar (32-bit output -> 8-bit local)
    ...
    // =========================================================================
    // Xilinx Video Test Pattern Generator IP (v_tpg_0) - 4 PPC 4K60
    // =========================================================================
    ...
    // =========================================================================
    // AES3 Audio Pattern Generator (BAR1 Offset 0x0100)
    // =========================================================================
    ...
    // =========================================================================
    // Dynamic EDID & HDMI HPD Controller (BAR1 Offset 0x0300)
    // =========================================================================
    ...
    // =========================================================================
    // PCIe AXI-Stream CQ / CC / RQ / RC Wires (Same widths as KU3P)
    // =========================================================================
    ...
    // =========================================================================
    // Instantiate UltraScale+ Compact PCIe Core (pcie4c_uscale_plus_0)
    // for Artix UltraScale+ AU15P - Gen3 x4, 256-bit AXI-Stream
    // =========================================================================
    pcie4c_uscale_plus_0 u_pcie_ip (
        .sys_clk                                   (sys_clk),
    ...
    // =========================================================================
    // Instantiate Custom PCIe DMA Controller Top Module (100% Shared with KU3P)
    // =========================================================================
    custom_pcie_dma_top #(
        ...
        // BAR1 AXI4-Lite Master Interface
