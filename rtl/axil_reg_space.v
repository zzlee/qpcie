...
module axil_reg_space #(
    ...
    // Version & Capability Constants (Canonical v3.0.0 Specification)
    localparam [31:0] VERSION_ID_VAL      = 32'h0300_0000; // v3.0.0 (Canonical Phase 6 Breaking Release)
...
`endif
    ...
    // ========================================================================
    // Phase 6: Canonical v3.0 Register File Declarations (Unconditional New Map)
    // ========================================================================
    wire map_mode_new = 1'b1; // Permanently active in Phase 6
    ...
    always @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            else if (s_axil_awvalid && s_axil_wvalid && (s_axil_awaddr[11:0] == 12'h504) && s_axil_wdata[1])
                adev0_xrun_sticky <= 1'b0;
        end
    end
        ...
        if (!rst_n) begin
            ...
            if (s_axil_awvalid && s_axil_wvalid && !s_axil_bvalid) begin
                ...
                case (s_axil_awaddr[11:8])
                    ...
                    4'h1: begin // VIDEO CH0 Block (0x0100 - 0x01FF)
                        case (s_axil_awaddr[7:0])
                            ...
                            8'h30: reg_h2c_ring_addr[31:0]      <= s_axil_wdata; // CH0 Ring1 Base L
                            8'h34: reg_h2c_ring_addr[63:32]     <= s_axil_wdata; // CH0 Ring1 Base H
                            8'h38: begin                                         // CH0 Ring1 Cfg
                    ...
                    4'h5: begin // AUDIO DEV0 Block (0x0500 - 0x05FF)
                        case (s_axil_awaddr[7:0])
                            8'h00: begin
