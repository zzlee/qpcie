...
TESTS=(
    ...
    "tb_video_cdc_system rtl/global_timer.v rtl/dma_telemetry.v rtl/qpcie_perfmon.v rtl/video_stream_engine.v rtl/sg_segment_walker.v rtl/nv12_capture_engine.v rtl/audio_stream_engine.v rtl/axil_reg_space.v rtl/c2h_dma_engine.v rtl/h2c_dma_engine.v rtl/desc_fetch_engine.v rtl/cq_rx_decoder.v rtl/cc_tx_encoder.v rtl/rq_tx_encoder.v rtl/rc_rx_decoder.v rtl/pcie_tag_manager.v rtl/interrupt_ctrl.v rtl/h2c_reorder_buffer.v rtl/sg_dma_engine.v rtl/sg_host_fetch_engine.v rtl/video_req_cdc.v rtl/custom_pcie_dma_top.v rtl/pcie_7x_axi_bridge.v tb/tb_video_cdc_system.v"
    "tb_pcie_dma_system rtl/global_timer.v rtl/dma_telemetry.v rtl/qpcie_perfmon.v rtl/video_stream_engine.v rtl/sg_segment_walker.v rtl/nv12_capture_engine.v rtl/audio_stream_engine.v rtl/axil_reg_space.v rtl/c2h_dma_engine.v rtl/h2c_dma_engine.v rtl/desc_fetch_engine.v rtl/cq_rx_decoder.v rtl/cc_tx_encoder.v rtl/rq_tx_encoder.v rtl/rc_rx_decoder.v rtl/pcie_tag_manager.v rtl/interrupt_ctrl.v rtl/h2c_reorder_buffer.v rtl/sg_dma_engine.v rtl/sg_host_fetch_engine.v rtl/video_req_cdc.v rtl/custom_pcie_dma_top.v tb/tb_pcie_dma_system.v"
    ...
    "tb_sg_dma_pipeline rtl/global_timer.v rtl/dma_telemetry.v rtl/qpcie_perfmon.v rtl/video_stream_engine.v rtl/sg_segment_walker.v rtl/nv12_capture_engine.v rtl/audio_stream_engine.v rtl/axil_reg_space.v rtl/c2h_dma_engine.v rtl/h2c_dma_engine.v rtl/desc_fetch_engine.v rtl/cq_rx_decoder.v rtl/cc_tx_encoder.v rtl/rq_tx_encoder.v rtl/rc_rx_decoder.v rtl/pcie_tag_manager.v rtl/interrupt_ctrl.v rtl/h2c_reorder_buffer.v rtl/sg_dma_engine.v rtl/sg_host_fetch_engine.v rtl/video_req_cdc.v rtl/custom_pcie_dma_top.v rtl/pcie_7x_axi_bridge.v tb/tb_sg_dma_pipeline.v"
)
