...
module tb_nv12_capture_4k_performance;
    ...
    nv12_capture_engine #(
        ...
        .sgl_y_wr_en(1'b0), .sgl_y_wr_addr(64'd0), .sgl_y_wr_len(32'd0), .sgl_y_wr_flags(32'd0),
        .sgl_uv_wr_en(1'b0), .sgl_uv_wr_addr(64'd0), .sgl_uv_wr_len(32'd0), .sgl_uv_wr_flags(32'd0),
